...
class Style {
	...
	public static function get_front_common_style() {
		...
		self::add_root( '--swl-content_font_size', SWELL::get_setting( 'post_font_size_sp' ) );
		self::add_root( '--swl-content_font_size', SWELL::get_setting( 'post_font_size_pc' ), 'tab' );
