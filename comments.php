...
<section id="comments" class="l-articleBottom__section -comment">
	<h2 class="l-articleBottom__title c-secTitle">
		<?=esc_html( \SWELL_FUNC::get_setting( 'comments_title' ) )?>
	</h2>
	<div class="p-commentArea">
		<?php if ( have_comments() ) : ?>
			<h3 class="p-commentArea__title -for-list">
				<i class="icon-bubbles"></i> <?=esc_html( __( 'List of comments', 'swell' ) )?>
		...
		<?php
			...
			comment_form(
				[
					'title_reply'          => __( 'To comment', 'swell' ),
					'label_submit'         => __( 'Send comment', 'swell' ),
