...
<div class="l-header__customBtn sp_">
	<?php if ( $SETTING['search_pos_sp'] === 'header') : ?>
		<div class="c-iconBtn" data-onclick="toggleSearch" role="button" aria-label="検索ボタン">
			<i class="c-iconBtn__icon <?=$btn2_icon?>"></i>
			<?php if ( $btn2_label !== '' ) : ?>
				<span class="c-iconBtn__label"><?=$btn2_label?></span>
			<?php endif; ?>
		</div>
	<?php elseif( $SETTING['custom_btn_url'] !== '' ) : ?>
		<a href="<?=$SETTING['custom_btn_url']?>" class="c-iconBtn">
			<i class="c-iconBtn__icon <?=$btn2_icon?>"></i>
			<?php if ( $btn2_label !== '' ) : ?>
				<span class="c-iconBtn__label"><?=$btn2_label?></span>
			<?php endif; ?>
...
<div class="l-header__menuBtn sp_">
	<div class="c-iconBtn -menuBtn" data-onclick="toggleMenu" role="button" aria-label="メニューボタン">
		...
		<?php if ( $menu_label ) : ?>
			<span class="c-iconBtn__label"><?=$menu_label?></span>
		<?php endif; ?>
	</div>
</div>
