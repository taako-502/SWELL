...
if ( $SETTING['show_page_links'] ) : // 前の記事・次の記事
	SWELL_FUNC::get_parts( 'parts/single/prev_next_link' );
endif;
...
if ( 'hide' !== $show_meta && ( 'show' === $show_meta || $SETTING['show_author'] ) ) :
	SWELL_FUNC::get_parts( 'parts/single/post_author', $post_data->post_author );
endif;
...
if ( 'hide' !== $show_meta && ( 'show' === $show_meta || $SETTING['show_related_posts'] ) ) :
	SWELL_FUNC::get_parts( 'parts/single/related_post_list', $the_id );
endif;
