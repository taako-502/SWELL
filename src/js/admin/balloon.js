 ...
 */
(function($) {
    console.log('Loaded balloon.js.');

    $(function() {
        // $('form').attr('autocomplete', 'off');

        let $swellBalloonMeta = $('.swl-meta--balloon');
        let $balloonBox = $swellBalloonMeta.find('.c-balloon');
        let $balloonBoxIcon = $balloonBox.find('.c-balloon__icon');
        let $balloonBoxBody = $balloonBox.find('.c-balloon__body');
        ...
        $('[name="balloon_icon"]').change(function() {
            ...
            let $iconImg = $balloonBox.find('.c-balloon__iconImg');
        ...
        $('[name="balloon_icon_name"]').on('input', function() {
            let thisVal = $(this).val() || $('[name="post_title"]').val();
